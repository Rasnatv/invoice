...
import '../bloc/fieldstaff/fieldstaff_bloc.dart';
import '../bloc/fieldstaff/fieldstaff_event.dart';
import '../bloc/fieldstaff/fieldstaffstate.dart';
...
class OwnerAddFieldStaffScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => FieldStaffBloc(repository: NewFieldStaffRepository())
...
class _OwnerAddFieldStaffView extends StatelessWidget {
  ...
  Widget _buildBody(BuildContext context, FieldStaffState state) {
    if (state.isLoading || state.status == FieldStaffStatus.initial) {
      return const Center(child: CircularProgressIndicator());
    }
    if (state.status == FieldStaffStatus.loadError && state.staffList.isEmpty) {
      return _ErrorState(

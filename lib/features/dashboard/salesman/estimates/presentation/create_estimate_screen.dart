...
//
//   // Sum of all items' incentive amounts (salesman-facing only, not part of
...
//   }
//
//   /// Called when the salesman picks a product from the dropdown. Auto-fills
...
//   /// with it. Size/unit are still editable afterwards (e.g. a custom cut
//   /// size) since the fields stay unlocked.
...
//       salesmanName: _salesmanCtrl.text.trim(),
//       salesmanMobile: _salesmanMobCtrl.text.trim(),
//       date: _date,
//       handlingCharge: _handlingCharge,
//       billType: billType,
//       status: billType == EstimateBillType.billed ? 'Pending' : 'Draft',
...
//                 label: 'Contactor  No.',
//                 field: CustomTextField(
//                   hint: 'Enter contractor phonenumber',
//                   icon: Icons.phone_outlined,
//                   keyboardType: TextInputType.phone,
...
//               SizedBox(height: Responsive.h(16)),
//
//               Text('Salesman', style: AppTextStyles.h3()),
//               SizedBox(height: Responsive.h(12)),
//               LabeledField(
//                 label: 'Salesman Name',
//                 field: CustomTextField(hint: 'Salesman name', icon: Icons.badge_outlined, controller: salesmanCtrl),
//               ),
//               SizedBox(height: Responsive.h(12)),
//             ],
//           ),
...
//                     Text(
//                       'Incentive: ${currency.format(item.incentiveAmount)} (${item.incentivePercent.toStringAsFixed(0)}% · auto)',
...
//               // stays visible. Incentive % comes from the product master.
//               Container(
//                 decoration: BoxDecoration(
...
//               // this is internal/salesman info, not part of the customer's
//               // bill total above.
//               Container(
//                 padding: EdgeInsets.all(Responsive.w(14)),
//                 decoration: BoxDecoration(
...
//           ),
//           right: PrimaryButton(label: 'Submit for Approval', height: 48, onPressed: onSubmit),
//         ),
//       ],
//     );
//   }
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              Text('Charges', style: AppTextStyles.h3()),
              SizedBox(height: Responsive.h(12)),
              LabeledField(

          ...
          child: ListView(
            ...
            children: [
              ...
              LabeledField(
                label: 'Salesman Mob.',
                field: CustomTextField(
                  hint: 'Salesman mobile',
                  icon: Icons.phone_iphone_outlined,
                  keyboardType: TextInputType.phone,
                  controller: salesmanMobCtrl,
                ),
              ),
              SizedBox(height: Responsive.h(12)),
            ],
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            // Dummy % shown until admin-configured incentive
                            // data is available per product.
                            Row(
                              children: [
                            ...
                            Text(
                              currency.format(currentIncentive),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      'Incentive: ${currency.format(item.incentiveAmount)} (${item.incentivePercent.toStringAsFixed(0)}% · dummy)',
                      style: AppTextStyles.caption(color: AppColors.success),
                    ),
                  ],
                ),
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              // bill total above. Values are dummy until admin config lands.
              Container(
                padding: EdgeInsets.all(Responsive.w(14)),
                decoration: BoxDecoration(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: Responsive.w(6)),
                        Text('(12000)', style: AppTextStyles.caption()),
                      ],
                    ),
                    Text(

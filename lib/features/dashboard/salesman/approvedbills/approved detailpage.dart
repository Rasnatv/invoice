...
//
//
// /// Read-only details page for a single estimate/bill.
// /// Reached from ApprovedBills (or any list) by tapping a tile.
// /// This is intentionally a separate screen from the 3-step
// /// CreateEstimateScreen's preview — nothing here is editable.
...
//                     rows: [
//                       _Row('Party Name', estimate.contractorName),
//                       _Row('Address', estimate.siteAddress),
//                       _Row('Contact No.', estimate.phone.isEmpty ? '-' : estimate.phone),
//                     ],
//                   ),
...
//                     title: 'Salesman',
//                     rows: [
//                       _Row('Name', estimate.salesmanName.isEmpty ? '-' : estimate.salesmanName),
//                       _Row('Mob.', estimate.salesmanMobile.isEmpty ? '-' : estimate.salesmanMobile),
//                     ],
//                   ),
...
//                 Expanded(child: Text(r.value.isEmpty ? '-' : r.value, style: AppTextStyles.body())),
//               ],
//             ),
//           )),
//         ],

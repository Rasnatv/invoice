...
import 'package:tileshop/features/dashboard/salesman/profile/presentation/viewprofile.dart';
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            _ProfileTile(icon: Icons.person_outline_rounded, label: 'My Profile', onTap: () {

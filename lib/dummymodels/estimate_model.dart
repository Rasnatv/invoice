...
/// Payment record for tracking individual payments against an estimate
class PaymentRecord extends Equatable {
  ...
  @override
  List<Object?> get props => [id, amount, date, paymentMethod, note];
}
...
class EstimateModel extends Equatable {
  ...
  /// Total amount paid so far against this estimate/bill.
  final double amountPaid;

  /// Complete payment history with individual payment records
  ...
  double get balance {
    final b = totalAmount - amountPaid;
    return b < 0 ? 0 : b;
  }
  ...
  PaymentRecord? get latestPayment =>
      paymentHistory.isNotEmpty ? paymentHistory.last : null;

  /// Get payments by payment method
  List<PaymentRecord> getPaymentsByMethod(String method) =>
      paymentHistory.where((p) => p.paymentMethod == method).toList();

  /// Get total amount paid by a specific payment method

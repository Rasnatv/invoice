...
//   /// In transit -> two signature pads + "Mark as Delivered".
...
//           SignaturePad(controller: _customerSigCtrl),
//           SizedBox(height: Responsive.h(14)),
//           Text('Driver Signature', style: AppTextStyles.caption()),
//           SizedBox(height: Responsive.h(6)),
//           SignaturePad(controller: _driverSigCtrl),
//           SizedBox(height: Responsive.h(18)),
//           SizedBox(
...
//     if (_customerSigCtrl.isEmpty || _driverSigCtrl.isEmpty) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text('Please capture both signatures before proceeding.')),
//       );
//       return;
//     }
//
//     final customerSig = await _customerSigCtrl.exportBase64();
//     final driverSig = await _driverSigCtrl.exportBase64();
//
//     if (customerSig == null || driverSig == null) {
//       if (!context.mounted) return;
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text('Could not capture signatures. Please try again.')),
//       );
//       return;
//     }
//

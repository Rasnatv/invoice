...
//     if (_isNavigating) return; // NEW: block re-entry while already navigating
//     _isNavigating = true;
...
//                                 .then((_) => _isNavigating = false); // NEW
//                           },
        ...
        children: [
          ...
          Row(
            children: [
              ...
              // UPDATED: Packing is now entered for every unit (not just
              // box units), so show it whenever it's actually present —
              // regardless of hasBoxPacking. Only fall back to the
              // measurement-qty summary when there's no packing text at
              // all.

...
class _IncentiveManagementScreenState extends State<IncentiveManagementScreen> {
  ...
  // NEW: guards against a second push/dialog firing while one route
  // transition is still animating (e.g. a fast double-tap on
  // Add/Edit/Delete). Without this guard, two overlapping transitions
  // can crash with:

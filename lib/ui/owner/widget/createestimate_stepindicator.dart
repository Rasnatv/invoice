...
//     required this.itemPackingCtrl, // NEW
...
//   final TextEditingController itemPackingCtrl; // NEW
...
//                       '${item.packing.isNotEmpty ? '   Pack: ${item.packing}' : ''}'
...
// NOTE: `AddedItem` and `EstimateStep` live in ownerestimatetype.dart so
// this file and the owner create-estimate screen share the exact same
// type. `AddedItem.amount` / `.incentiveAmount` are stored fields set
// once — from the server's /quotations/product-incentive response — at
// the moment an item is added. There is no local quantity*rate preview

...
//       context.read<OwnerEstimateBloc>().add(const OwnerProductIncentiveCleared());
//       return;
//     }
//
//     _incentiveDebounce = Timer(_incentiveDebounceDuration, () {
//       if (!mounted) return;
//       context.read<OwnerEstimateBloc>().add(OwnerProductIncentiveRequested(
//         productId: productId,
//         quantity: qty,
//         rate: rate,
//       ));
...
//     final product = _selectedProduct!;
//
//     final incentiveState = context.read<OwnerEstimateBloc>().state;
...
// =====================================================================
//
// All totals/quantities shown here come straight from state.preview
// (QuotationPreviewData), fetched by the parent via
// OwnerQuotationPreviewRequested. Nothing on this step is computed from
// the locally-added items list anymore, except:
//   - Additional Discount + Payment Received, because
//     POST /quotations/preview has no discount/payment fields — the
...
//     server's grand_total, and are only ever sent to the backend on
//     submit (action = 'approve').
//   - Incentive figures are intentionally not surfaced on this screen.
// =====================================================================

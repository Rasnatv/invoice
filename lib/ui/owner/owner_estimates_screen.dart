...
import '../../bloc/ownerbloc/ownerestimatelist_bloc.dart';
import '../../bloc/ownerbloc/ownerestimatelist_event.dart';
import '../../bloc/ownerbloc/ownerestimatelistevent_state.dart';
import 'ownerestuimatedetailscreen.dart';
...
class _OwnerEstimateCard extends StatelessWidget {
  const _OwnerEstimateCard({super.key, required this.estimate, required this.onTap});

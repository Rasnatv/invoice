            ...
            child: BlocListener<OwnerCancelQuotationBloc, OwnerCancelQuotationState>(
              ...
              child: BlocConsumer<OwnerQuotationDetailBloc, OwnerQuotationDetailState>(
                ...
                builder: (context, state) {
                  ...
                  // Same "only if at least one item has it" rule used on the
                  // salesman-facing quotation preview screen, so both
                  // screens (which share QuotationDetailModel) behave the
                  // same way.

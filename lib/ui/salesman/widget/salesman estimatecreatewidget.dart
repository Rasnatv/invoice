...
// =====================================================================
// STEP 3 — PREVIEW
// Box Qty / Piece Qty columns now only render when at least one item
// in the preview actually has box/piece quantities — otherwise those
// two columns are omitted entirely instead of showing '-' for every row.
// =====================================================================
        ...
        Expanded(
          child: BlocBuilder<SalesmanEstimateBloc, SalesmanEstimateState>(
            ...
            builder: (context, state) {
              ...
              // item actually has box/piece quantities — avoids two
              // all-'-' columns cluttering the table for non-box-unit
              // estimates.
              final hasBoxPieceData = preview.items.any(
                    (item) => item.boxQuantity > 0 || item.pieceQuantity > 0,
              );

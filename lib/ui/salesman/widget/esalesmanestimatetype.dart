...
class AddedItem {
  ...
  /// field at the moment this item was added) — not recomputed locally,
  /// since the server may calculate it from square feet / box-piece
  /// breakdown rather than a plain quantity * rate.
  final double amount;

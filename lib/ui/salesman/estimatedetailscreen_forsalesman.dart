                    ...
                    children: [
                      ...
                      _DetailSection(
                        ...
                        rows: [
                          ...
                          _Row('Address', estimate.customerAddress, icon: Icons.location_on_outlined),
                          _Row('Contact No.', estimate.customerPhone, icon: Icons.phone_outlined),
                      ...
                      _DetailSection(
                        ...
                        rows: [
                          ...
                          _Row('Contact No.', estimate.customer.phone, icon: Icons.phone_outlined),
                      ...
                      Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: DataTable(
                            ...
                            columnSpacing: 18,
                            // Incentive column is hidden for owners.
                            columns: [
                            ...
                            rows: estimate.items.asMap().entries.map((entry) {
                              ...
                              return DataRow(cells: [
                                ...
                                DataCell(Text(item.mrp > 0 ? currency.format(item.mrp) : '-')),
                                DataCell(Text(number.format(item.rate))),
                                DataCell(Text(
                                  currency.format(item.amount),
                                  style: AppTextStyles.bodyBold(),
                                )),
                                // Must mirror the `if (!isOwner)` column above
                                // 1:1, otherwise DataTable throws an
                                // assertion error (cell/column count mismatch).
                                if (!isOwner)
                                  DataCell(Text(
                                    item.incentiveAmount > 0

...
//                                   const DataColumn(label: Text('Unit')),
//                                   const DataColumn(label: Text('Box Qty'), numeric: true),      // NEW
//                                   const DataColumn(label: Text('Piece Qty'), numeric: true),    // NEW
...
//                                     DataCell(Text(number.format(item.quantity))),
//                                     DataCell(Text(item.productUnit)),
//                                     DataCell(Text(item.boxQuantity > 0                                   // NEW
//                                         ? number.format(item.boxQuantity) : '-')),
//                                     DataCell(Text(item.pieceQuantity > 0                                 // NEW

...
// step and on ApprovedDetailsScreen. Once the backend/admin panel exposes a
// per-product incentive %, replace `_dummyIncentivePercent` with the real
// value from item/master data and remove this constant.
...
class EstimateDetailsScreen extends StatelessWidget {
  ...
  void _shareOnWhatsApp() {
    ...
    buffer
      ..writeln('')
      ..writeln('Grand Total: ${currency.format(estimate.totalAmount)}')

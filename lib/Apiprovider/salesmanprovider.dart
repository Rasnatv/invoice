...
// }
//
// /// Same shape as FieldStaffProvider: plain result objects, no bloc/state
// /// logic. On 401, ApiErrorHandler.handleDioError already clears the token
// /// and redirects to login, so isUnauthorized lets the bloc skip a
...
//         if (parsed.status == '1') return SalesmanListResult.success(parsed.data);
...
//   }
// }
// Apiprovider/salesmanprovider.dart

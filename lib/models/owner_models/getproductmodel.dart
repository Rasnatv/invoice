...
class ProductModel {
  ...
  /// Empty string when the product's unit isn't a "box"-type unit, or when
  /// no value was saved for this product on the server.
  final String piecesPerBox;

  /// Empty string when no packing value was saved for this product on the
  /// server. This is NOT a parsing bug — it mirrors exactly what the API
  /// returns (see ProductModel.fromJson below).
  final String packing;

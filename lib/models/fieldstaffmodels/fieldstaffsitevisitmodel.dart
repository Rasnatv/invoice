...
class SiteVisitGroupModel {
  ...
  /// Returns a copy with [list] swapped out (used when appending pages)
  /// while keeping the server-reported [count] unless overridden.
  SiteVisitGroupModel copyWith({List<SiteVisitListItemModel>? list, int? count}) {
    return SiteVisitGroupModel(
...
class SiteVisitMyDataModel {
  ...
  /// Returns a copy with just the "all" group's list replaced — used by
  /// the bloc to append newly-fetched pages onto the existing "all" list
  /// without touching totals/today.
  SiteVisitMyDataModel copyWithAllList(List<SiteVisitListItemModel> newAllList) {
    return SiteVisitMyDataModel(
      totalVisits: totalVisits,
      todayVisits: todayVisits,
      totalIncentive: totalIncentive,
      today: today,
      all: all.copyWith(list: newAllList),
    );
  }
}
